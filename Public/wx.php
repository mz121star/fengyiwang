...
class weixin {
    ...
    private function transmitNews($object) {
        ...
        if ($object->EventKey == 'fy_jblx') {
        ...
        } elseif ($object->EventKey == 'fy_tuan') {
            $item_str = sprintf($itemTpl, '团购', '团购', '', $_SERVER['SERVER_NAME'].'/index.php/weixin/'.$object->FromUserName.'/tuan');
            ...
            $item_str = sprintf($itemTpl, '欢迎关注人人汇', '加关注摇红包', 'http://'.$_SERVER['SERVER_NAME'].'/upload/index.jpg', $_SERVER['SERVER_NAME'].'/index.php/Shake/' );
